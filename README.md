...
Current status is a MVP Proof of Concept that functions in VMware and VirtualBox, and on Intel & VIA controllers with Realtek codecs; further development and testing is needed to support more real hardware.
...
See the MIT LICENSE file for more information about lack of warranty. For customer support, file an issue on Github or refer to the complaints department of the Sirius Cybernetics Corporation. 
