...
Current status is a MVP Proof of Concept that functions in VMware and VirtualBox, and on Intel & VIA controllers up to ~2011 with Realtek codecs; further development and testing is needed to support more real hardware.
