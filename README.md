...
Current status is a MVP Proof of Concept that functions in VMware and VirtualBox, and on many Intel controllers with Realtek codecs; further development and testing is needed to support more real hardware.
...
If you want to use this in some kind of business critical production application, I would highly recommend either a Sound Blaster Live, CMI8738 or any $2 USB Audio dongle instead. (Seriously, almost all of the cheapest USB dongles work perfectly in 98se/Me. If you're using QuickInstall 0.9.6 you will need to add the wdma_usb.inf file back to C:\Windows\Inf though)
...
- Only supports 22-48khz 16-bit sample rate (up to 96khz 32-bit could technically be added but 9x doesnt make the best choices about resampling)
